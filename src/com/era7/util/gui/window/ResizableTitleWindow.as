package com.era7.util.gui.window
{
	import flash.events.*;
	...
	*/                                                                                                                                    
	public class ResizableTitleWindow extends TitleWindow
	{
	   ...
	   [Embed(source="../../../../../../icons/flechas/flecha_negra_v.png")]
	   public static var sizeNSCursorSymbol:Class;
	
	   [Embed(source="../../../../../../icons/flechas/flecha_negra_d.png")]
	   public static var sizeNESWCursorSymbol:Class;
	   
	   [Embed(source="../../../../../../icons/flechas/flecha_negra_h.png")]
	    ...
	    override protected function createChildren():void
	   	{
		    ...
		    /*
		    //-----------------Adding the resize icon---------------
		    var canvas:Canvas = new Canvas();
		    canvas.percentHeight = 100;
		    canvas.percentWidth = 100;
		    var resizeImage:Image = new Image();
		    resizeImage.source = resizeIcon;
		    resizeImage.setStyle("right",0);
		    resizeImage.setStyle("bottom",0);
		    canvas.addChild(resizeImage);
